...
<div class="right_col" role="main">
  <div class="">
    <div class="clearfix"></div>@if ($message = Session::get('error'))
    <div class="alert alert-error alert-dismissible " role="alert">
      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span>
      </button> <strong>Error</strong> {{ $message }}</div>@endif @if ($message = Session::get('success'))
    <div class="alert alert-success alert-dismissible " role="alert">
      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span>
      </button> <strong>Success</strong> {{ $message }}</div>@endif
         ...
         <div id="collapseOne" class="panel-collapse collapse in">
          <div class="card-body">
            <ol type="1" style="line-height: 2.0; color: black">
              <li>Tanda plus berwarna biru
                <img src="{{ URL::asset('adminutama/production/images/open.png')}}">digunakan untuk melihat apa aja sih detail dari setiap palamar.</li>
              ...
              <ol type="a">
                <li><u><b>Pangajuan pelamar ke koprodi, dekan dll, baru bisa dilakukan ketika pelamar telah siap mengisi form permohonan kerja.</b></u>
                </li>
              </ol>
              <li>Button
                <button type="button" class=" btn btn-round btn-info btn-sm"><span class="fa fa-comments-o"></span> 
                </button>digunakan untuk melihat pesan dari DKK, koprodi atau dekan</li>
              <li>Button
                <button type="button" class="btn btn-round btn-secondary btn-sm"><span class="fa fa-upload"></span> 
                </button>digunakan untuk mengupload hasil KOREKSI Aptitude dan DISC dari yang telah dikerjakan pelamar</li>
      ...
      @if(Auth::user()->level == 3 || Auth::user()->level == 4 ||Auth::user()->level == 5)
        ...
        <div id="accordion">
          ...
          <div class="card-header" style="margin-bottom: 0px; padding: 0px;">
            ...
            <font size="2px" color="black"><span class="fa fa-info-circle"></span> Catatan <div class="spinner-grow spinner-grow-sm text-danger spinner-grow" id="growspinner" role="status" style="float:right">
                  <span class="sr-only">Loading...</span>
                </div></font>
            </a>
            </h4>
            ...
            <div class="card-body">
              <ol type="1" style="line-height: 2.0; color: black">
                <li>Tanda plus berwarna biru
                  <img src="{{ URL::asset('adminutama/production/images/open.png')}}">digunakan untuk melihat apa aja sih detail dari setiap palamar.</li>
                <ol type="a">
                  <li>Dalam memutuskan calon pelamar klik button
                    <button type="button" title="Tinggalkan pesan" class=" btn btn-round btn-danger btn-sm"><span class="fa fa-paper-plane"></span> Putuskan</button>yang akan ditemukan jika mengklik
                    <img src="{{ URL::asset('adminutama/production/images/open.png')}}">
                  </li>
                </ol>
                <li>Button
                  <button type="button" class=" btn btn-round btn-info btn-sm"><span class="fa fa-comments-o"></span> 
      ...
      <div class="x_content">
      <div class="card-header bg-info p-0 pt-1 border-bottom-0" id="myTab">
        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="tab" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" ><span class="fa fa-spinner"></span> Baru <span class="badge badge-danger"></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-three-waiting-tab" data-toggle="tab" href="#custom-tabs-three-waiting" role="tab" aria-controls="custom-tabs-three-waiting" aria-selected="false" ><span class="fa fa-times"></span> Ditolak <span class="badge badge-danger"></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="tab" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false"><span class="fa fa-check-circle"></span> Diterima</a>
          </li>
      ...
      <!--UNTUK BAGIAN BARU-->
      <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="home-tab">
      
          <div class="x_panel shadow-sm p-1">
              <div class="x_title">
                <h2>List Pemohon <small>pelamar</small></h2>
                <div class="clearfix"></div>
              </div>
                <div class="table-responsive">
                  <table id="datatablepemohon" class="table table-striped table-bordered table-hover p-1" width="100%">
                    <thead>
                      <tr>
                        <th>
                          <center><span class="fa fa-eye"></span>
                          </center>
                        </th>
                        <th></th>
                        <th></th>
                        ...
                        <th style="text-align: center; max-width: 1px;">Aksi</th>
      ...
      <div class="tab-pane fade" id="custom-tabs-three-waiting" role="tabpanel" aria-labelledby="profile-tab">
          ...
          <div class="x_panel shadow-sm p-1">
              <div class="x_title">
                ...
                <div class="table-responsive">
                  <table id="tableditolak" class="table table-striped table-bordered table-hover p-1" width="100%">
                    <thead>
                      <tr>
                        <th>
                          <center><span class="fa fa-eye"></span>
                        ...
                        <th>id user</th>
                        <th>Nama Lengkap</th>
                        <th>Jenis Kelamin</th>@if(Auth::user()->level == 1)
                        <th style="text-align: center; max-width: 1px;">Aksi</th>
                        <th>Status Selesai</th>@endif @if(Auth::user()->level == 3 || Auth::user()->level == 4)
                        <th>Pesan</th>@endif
                        <th>Bidang Terkait</th>
                        <th>DKK</th>
                      </tr>
      ...
      <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="contact-tab">
          ...
          <div class="x_panel shadow-sm p-1">
              <div class="x_title">
                ...
                <div class="table-responsive">
                  <table id="tableselesai" class="table table-striped table-bordered table-hover p-1" width="100%">
                    <thead>
                      <tr>
                        <th>
                          <center><span class="fa fa-eye"></span>
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-body">
         <input type="text" class="id_userpesan" readonly="" style="background-color: white; border: 0px; font-weight: bold;">
         <hr>
...
<!--ALTERNATIF JIKA KEMBALI AKAN AUTOMATIS MENAMPILKAN MODAL REVISI DARI PAK IRFAN-->
<div class="modal fade bs-example-modal-lg" id="linkdetail2" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-body">
        <input type="text" value="{{ $nama_back }}" readonly="" style="background-color: white; border: 0px; font-weight: bold;">
         <hr>
          <div class="row justify-content-md-center">
            <form action="{{ Route('viewdatadiriau') }}" role="form" method="POST">
              @csrf

              <input type="hidden"  name="id_user" value="{{$id_user_back}}">
              <button type="submit" class="btn btn-round btn-outline-primary btn-sm"><span class="fa fa-male"></span>|<span class="fa fa-female"></span> Data Diri</button>
            </form>
  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      ...
      <form action="{{ Route('SimpanPesan') }}" role="form" method="POST" onsubmit="return confirm('Pastikan keputusan sudah tepat, anda yakin untuk melanjutkannya ?');">
        <div class="modal-body">
          <div class="left-content-md-center">@csrf
            <input type="hidden" name="id_user" class="id_userpesan">@if(Auth::user()->level == 3)
            <input type="hidden" name="cekpengecek" value="3">@endif @if(Auth::user()->level == 4)
            <input type="hidden" name="cekpengecek" value="4">@endif
            <div class="col-md-12">
              <div class="radio">
                <label>
                  <input type="radio" class="flat" name="status_keputusan" value="1" required="">Iya, saya oke dengan pelamar ini</label>
                <label>
                  <input type="radio" class="flat" name="status_keputusan" value="2" required="">Tidak, saya kurang dengan pelamar ini</label>
                <br> <font color="red" size="2"> *keputusan yang dipilih akan diteruskan kebagian kepegawaian</font>
                <br>
              </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group" >
                <label for="nama_perguruantinggi">Pilih File:</label>
                  ...
                  <br>
                  <font color="red" size="2">File Yang Diizinkan <b><u>HANYA</u></b>.zip .pdf, .docx, .doc, .xls, .xlsx Maks 20 mb</font>
...
if(empty($id_user_back)){

}else{ ?>

  <script type="text/javascript">
    jQuery( document ).ready(function( $ ) {
      $('#linkdetail2').modal('show');
        ...
        columns: [
            {
                ...
                "orderable":      false,
                //"data":           'id_surattugas',
                "defaultContent": '<div class="spinner-grow spinner-grow-sm text-info" role="status"><span class="sr-only">Loading...</span></div>'
            },
...
jQuery( document ).ready(function( $ ) {
    //BAGIAN TABLE SELESAI
    var dt =  $('#tableselesai').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('DataPemohonSelesai') !!}',
        columns: [
            {
                "class":          "details-control",
                "orderable":      false,
  ...
  var detailRows = [];
  // Add event listener for opening and closing details
    $('#tableselesai tbody').on('click', 'td.details-control', function () {
        var tr = $(this).closest('tr');
        var row = dt.row( tr );
...
jQuery( document ).ready(function( $ ) {
  ...
  //BAGIAN TABLE BAGIAN DITOLAK
    var dt =  $('#tableditolak').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('DataPemohonDitolak') !!}',
        columns: [
            {
                "class":          "details-control",
                "orderable":      false,
  ...
  var detailRows = [];
  // Add event listener for opening and closing details
    $('#tableditolak tbody').on('click', 'td.details-control', function () {
        var tr = $(this).closest('tr');
        var row = dt.row( tr );
...
file2.onchange = function() {
   for (var i = 0; i < file2.files.length; i++) {
        if(this.files[i].size > 20971520){
           swal.fire( file2.files.item(i).name  +  "", "File Mungkin Lebih 20MB!", "error");
           this.value = "";
        }
        var ext = file2.files[i].name.substr(-3);
        var ygempat = file2.files[i].name.substr(-4);
        if(ext!== "PDF" && ext!== "pdf" && ygempat!== "docx" && ext!== "doc" && ext!== "xls" && ygempat!== "xlsx" && ext!== "zip")  {
