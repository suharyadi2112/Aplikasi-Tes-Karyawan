...
<div class="container-fluid">
    <div class="row">
      <div class="col-10 mx-auto">
        ...
        <div class="card">
         <div class="card-body">
          <form data-route="{{ route('updateDataDiri', ['id'=>$id_user]) }}" data-routeback="{{ route('pemohonindex') }}" id="myFormupdatedatadiri" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
            {{ csrf_field() }}
