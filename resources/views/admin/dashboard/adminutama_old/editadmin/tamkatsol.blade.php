          ...
          <div class="x_panel shadow-sm">
            <div class="x_title">
                ...
                <div class="x_content">
                  <div class="row">
                    <div class="col-sm-8">
                      <form data-route="{{ route('edittamkatsol' , ['id' => $id_tambahan]) }}"  id="tamkat" role="form" method="POST" accept-charset="utf-8">
                        {{ csrf_field() }}
                          ...
                          <div class="col-md-6">
                            <div class="form-group" >
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{ $detail_ptk }}" name="detail_ptk" placeholder="Masukan Detail" required/>
                              </div>
                              ...
                              <div class="form-group" >
                                ...
                                <div class="input-group">
                                  ...
                                  <select class="target form-control" name="kategori" id="kategori" required >
                                      ...
                                      <option value="{{$b->id_kategori}}" @if($b->nama_kategori==$kategori) selected='selected' @endif>{{$b->nama_kategori}}</option>                                        
                                      @endforeach
                                  </select>
                                </div>
                                  <div class="help-block with-errors text-danger"></div>
                            ...
                            <div class=" col-md-12" >
                              <div class="form-group" >
                                ...
                                <div class="input-group" >
                                    ...
                                    <textarea class="textarea123" id="dataphplama" name="soal">{{ $soal }}</textarea>
